...
import 'package:assignment/screens/switch_page_dialog.dart';
import 'package:assignment/screens/color_picker_dialog.dart';
...
class _CarouselDemoState extends State<CarouselDemo> {
  ...
  List<List<List<String>>> _undoTextStacks = List.generate(4, (_) => []);
  List<List<List<String>>> _redoTextStacks = List.generate(4, (_) => []);
  List<List<List<String>>> _undoFontFamilyStacks = List.generate(4, (_) => []);
  List<List<List<String>>> _redoFontFamilyStacks = List.generate(4, (_) => []);
  List<List<List<double>>> _undoFontSizeStacks = List.generate(4, (_) => []);
  List<List<List<double>>> _redoFontSizeStacks = List.generate(4, (_) => []);
  List<List<List<Color>>> _undoColorStacks = List.generate(4, (_) => []);
  List<List<List<Color>>> _redoColorStacks = List.generate(4, (_) => []);
